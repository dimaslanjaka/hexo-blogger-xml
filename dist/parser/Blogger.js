...
var BloggerParser = /** @class */ (function (_super) {
  ...
  function BloggerParser(xmlFile) {
    ...
    if (!(0, fs_1.existsSync)(xmlFile)) throw xmlFile + " not found";
    // reset result
    _this.parseXmlJsonResult = [];
    // clean build dir
    _this.clean();
  ...
  BloggerParser.prototype.parseEntry = function () {
    ...
    var _loop_1 = function (index) {
      ...
      if (excludeTitle.includes(title.toLowerCase().trim())) return "continue";
      ...
      (0, util_1.writeFileSync)(
        path.join(this_1.entriesDir, (0, sanitize_filename_1["default"])(title) + ".json"),
  ...
  BloggerParser.prototype.getJsonResult = function () {
    var _this = this;
    if (!(0, fs_1.existsSync)(this.entriesDir)) throw "Entries Dir Not Found, previous process failed";
            ...
            try {
              ...
              if (typeof json.entry.link[4] != "undefined") {
                ...
                json.entry.category.forEach(function (category) {
                  ...
                  if (!url_1["default"].isValidURL(cat)) buildPost.headers.tags.push(cat);
                });
                // post published
                ...
                buildPost.headers.subtitle = (0, trim_whitespaces_1["default"])(
                  (0, remove_double_quotes_1["default"])(mod.description)
                ).replace(new RegExp("[^a-zA-Z., ]", "m"), "");
                // site title
                buildPost.headers.webtitle = config_1["default"].webtitle;
                if (buildPost.permalink.length > 0) {
                  var saveFile = path.join(
              ...
              (0, util_1.writeFileSync)(
                path.join("build/hexo-blogger-xml/errors/", "error-" + (0, path_1.basename)(file)),
                JSON.stringify(json, null, 2)
              );
              (0, util_1.writeFileSync)(
                path.join(
                  "build/hexo-blogger-xml/errors/",
                  "error-body-" + (0, path_1.basename)(file, ".json") + ".html"
                ),
                buildPost.content
              );
              //buildPost.content
  ...
  BloggerParser.prototype.objTrim = function (obj) {
    Object.keys(obj).map(function (k) {
      return (obj[k] = typeof obj[k] == "string" ? obj[k].trim() : obj[k]);
    });
    return obj;
  };
